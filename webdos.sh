...
echo -e "$Cafe##############################################################################$nc"
echo -e "$Cafe##   \e[31m▄▄      ▄▄  \e[5aLm0r5    ▄▄        ▄▄▄▄▄       ▄▄▄▄     $Cafe                   ##"
echo -e "$Cafe##   ██      ██           ██        ██▀▀▀██    ██▀▀██                  $Cafe     ##"
...
echo -e  "$Cafe##   \e[31m▀▀▀  ▀▀▀    ▀▀▀▀▀   ▀▀ ▀▀▀    ▀▀▀▀▀       ▀▀▀▀     ▀▀▀▀▀▀      $Cafe        ##"
echo -e "$Cafe##############################################################################$nc"
echo -e "##$red-------------MOST POWERFULL WEBSITE DDOS ATTACKER------------BY aLm02r5$nc     ##"
echo -e "$Cafe##############################################################################$nc"
echo -e "$cyan Author :-aLm02r5 CHAVDA$nc"
...
read -p $'\033[0;37mWEBSITE (almo83)\e[0m     :- ' web
read -p $'\033[0;37mPORT (almnfz)\e[0m      :- ' port
read -p $'\033[0;37mTHREAD [133]\e[0m :- ' thread
